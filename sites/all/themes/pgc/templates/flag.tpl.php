...
<span class="flag-wrapper flag-<?php echo $flag_name_css; ?>">
  ...
  <?php if ($after_flagging): ?>
    <div id="flag-confirmation">
    	<div id="flag-top">
    		<h2>Thank you for signing up for a Graduation Coach Campaign workshop!</h2>
    		<p>You are officially registered for this workshop.  If you have any questions about this specific workshop, please call 215-686-2176.</p>
    	</div>
    	<div id="flag-bottom">
